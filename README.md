...
When the cache auto-generates a query key, it's hashed, making it extremely difficult to remove it from the cache. If you need to remove the results from the cache at any given time, use a custom key.
